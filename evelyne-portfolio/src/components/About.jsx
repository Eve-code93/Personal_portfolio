    ...
    <section id="about" className="py-20 px-4 border-t border-[#c4bcb3]/30 bg-[#e6e1d3]">
      <div className="max-w-4xl mx-auto text-center">
        ...
        >
          ...
          I'm constantly learning and thrive in collaborative, fast-paced environments that challenge my creativity and technical skills.
        </motion.p>
        ...
        >
          ...
          >
            Medium
          </a>, exploring UI/UX trends, and contributing to open-source projects. My goal is to use technology to create meaningful digital products that leave a lasting impact.
        </motion.p>
      </div>
    </section>
  );
